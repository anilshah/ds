...
public class MDIWindow extends JFrame implements WindowListener {
    ...
    protected JMenuBar CreateJMenuBar() {
        ...
        mnuPassengers = new JMenuItem("Passengers");
    ...
    ActionListener menulistener = new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (ActCmd.equalsIgnoreCase("calculator")) {
            ...
            else if(ActCmd.equalsIgnoreCase("mannual")){

              String path="C:\\Program Files\\Microsoft Office\\Office12\\WINWORD.exe C:\\projectreport.docx";
              ...
              Runtime rt = Runtime.getRuntime();
                 ...
                 JOptionPane.showMessageDialog(null, "Error,Cannot open User Manual", "Applicaton Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void ConfirmExit() {
        ...
        int PromptResult = JOptionPane.showOptionDialog(null, "Are you sure to exit?","Confirm exit", JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, ObjButtons, ObjButtons[1]);
        if (PromptResult == 0) {
            System.exit(0);
        }//if closed
    }//ConfirmExit() closed
