...
class Scheduling_report extends JInternalFrame {
    ...
    public Scheduling_report() {
        ...
        super("Scheduling Report",true,true,true,true);
...
//        setResizable(false);
    ...
    private void printList() {
        try {
            ...
            ResultSet rst = DBConnection.getDBConnection().createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE).executeQuery("select Bus_No,Route_No,empNo,Trip_No,Date_Scheduled from Schedules");
