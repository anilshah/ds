...
public class UpdateRoute extends JInternalFrame {
    ...
    public UpdateRoute(String route, String name, String from, String to,String distance, String amount)
    {
        ...
        txtAmount.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent e) {
                ...
                if (!(Character.isDigit(c) ||(c == KeyEvent.VK_BACK_SPACE) ||(c == KeyEvent.VK_SPACE) ||(c == KeyEvent.VK_DELETE)))
                {
                    ...
                    getToolkit().beep();
                    JOptionPane.showMessageDialog(null, "Amount is in Digit", "ERROR",JOptionPane.DEFAULT_OPTION);
                    e.consume();
                }
            }
        });
        txtDistance.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent e) {
                ...
                if (!(Character.isDigit(c) ||(c == KeyEvent.VK_BACK_SPACE) ||(c == KeyEvent.VK_SPACE) ||(c == KeyEvent.VK_DELETE)))
                {
                    ...
                    getToolkit().beep();
                    JOptionPane.showMessageDialog(null, "Distance in digit", "ERROR",JOptionPane.DEFAULT_OPTION);
                    e.consume();
                }
            }
        });
        ...
        Update.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (txtRouteNo.getText() == null ||txtRouteNo.getText().equals("")) {
                    JOptionPane.showMessageDialog(null, "Enter route number", "Error",JOptionPane.DEFAULT_OPTION);
                    txtRouteNo.requestFocus();
                    return;
                }
                if (txtRouteName.getText() == null ||txtRouteName.getText().equals("")) {
                    JOptionPane.showMessageDialog(null, "Enter route name", "tobiluoch",JOptionPane.DEFAULT_OPTION);
                    txtRouteName.requestFocus();
                    return;
                }
                if (txtFrom.getText() == null ||txtFrom.getText().equals("")) {
                    JOptionPane.showMessageDialog(null, "Enter From", "tobiluoch",JOptionPane.DEFAULT_OPTION);
                    txtFrom.requestFocus();
                    return;
                }
                if (txtTo.getText() == null ||txtTo.getText().equals("")) {
                    JOptionPane.showMessageDialog(null, "Enter To", "tobiluoch",JOptionPane.DEFAULT_OPTION);
                    txtTo.requestFocus();
                    return;
                }
                if (txtDistance.getText() == null ||txtDistance.getText().equals("")) {
                    JOptionPane.showMessageDialog(null, "Enter Distance", "tobiluoch",JOptionPane.DEFAULT_OPTION);
                ...
                try {
                    ...
                    {
                        String temp = "UPDATE Route SET " +"  RouteName        ='" + txtRouteName.getText() +"',Depot           ='" + txtFrom.getText() +"',Destination    ='" + txtTo.getText() +"',Distance   ='" + txtDistance.getText() +"',Fare_Charged='" + txtAmount.getText() +"' WHERE Route_No LIKE'" + txtRouteNo.getText() + "'";
        ...
        Search.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    {
                        JOptionPane.showMessageDialog(null, "Enter route number to search", "Error",JOptionPane.DEFAULT_OPTION);
                    }
                    return;
                //}
                } catch (SQLException sqlex) {
