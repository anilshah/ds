...
public class AddPassenger extends JInternalFrame {
        ...
        button1.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                ...
                if (text2.getText() == null ||text2.getText().equals("")) {
                    JOptionPane.showMessageDialog(null, "Enter passenger name", "Error",JOptionPane.DEFAULT_OPTION);
                    text2.requestFocus();
                    return;
                }
                ...
                if (text4.getText() == null ||text4.getText().equals("")) {
                    JOptionPane.showMessageDialog(null, "Enter telephone number", "Error",JOptionPane.DEFAULT_OPTION);
                    text4.requestFocus();
                    return;
                }
                ...
                try {
                    ...
                    {
                        String temp = "INSERT INTO Passenger(Pass_No, Pass_Name, Address, Tel_No, Date_of_Travel,Depot,Des) VALUES ('" +text1.getText() + "', '" +text2.getText() + "', '" +text3.getText() + "', '" +text4.getText() + "', '" +dob.getText() + "', '" +combo1.getSelectedItem() + "', '" +combo2.getSelectedItem() + "')";

                        int result = statement.executeUpdate(temp);
                        String ObjButtons[] = {"Yes", "No"};
                        int PromptResult = JOptionPane.showOptionDialog(null, "Record succesfully added.Do you want to add another?","Success", JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, ObjButtons, ObjButtons[1]);
                        if (PromptResult == 0) {
                            generator();
                            text2.setText("");
                            text3.setText("");
    ...
    private void generator() {
        ...
        try {
            ResultSet rst = DBConnection.getDBConnection().createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_UPDATABLE).executeQuery("SELECT Pass_No FROM Passenger");
