...
public class frmSplash{
    ...
    public frmSplash(int duration) {
        ...
        window.setBounds((screen.width - 1090) / 2, (screen.height - 300) / 2,1101, 303);


        panel=(JPanel)window.getContentPane();
        SplashImage = new JLabel(new ImageIcon(ClassLoader.getSystemResource("images/bustour.JPG")));
