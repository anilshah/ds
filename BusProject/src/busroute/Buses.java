...
Dimension screen = Toolkit.getDefaultToolkit().getScreenSize();
    ...
    labelhead=new JLabel("Bus Details");
     labelhead.setIcon(new ImageIcon(ClassLoader.getSystemResource("images/Buses.png")));
     ...
     add(labelhead, BorderLayout.NORTH);
        ...
        tablePanel.add(buttonPanel, java.awt.BorderLayout.SOUTH);
        tablePanel.setPreferredSize(new java.awt.Dimension(screen.width-80, screen.height-400));
    ...
    public int print(Graphics g, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        double headerHeightOnPage =tblBusList.getTableHeader().getHeight() * scale;
        double tableWidthOnPage = tableWidth * scale;

        double oneRowHeight = (tblBusList.getRowHeight() +tblBusList.getRowMargin()) * scale;
