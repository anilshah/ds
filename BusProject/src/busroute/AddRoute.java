...
public class AddRoute extends JInternalFrame {
    ...
    public AddRoute() {
        ...
        To = new JLabel("To");
        Distance = new JLabel("Distance[in KM]");
        ...
        txtRouteName.addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent e) {
                char c = e.getKeyChar();
                if (!(Character.isLetter(c)||(c == KeyEvent.VK_MINUS) ||(c == KeyEvent.VK_BACK_SPACE) ||(c == KeyEvent.VK_SPACE) ||(c == KeyEvent.VK_DELETE)))
                {
        ...
        AddNew.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                {
                    JOptionPane.showMessageDialog(null, "Enter route name", "ERROR",JOptionPane.DEFAULT_OPTION);
                    txtRouteName.requestFocus();
                    return;
                }
                if (txtFrom.getText() == null ||txtFrom.getText().equals(""))
                {
                    JOptionPane.showMessageDialog(null, "Enter From", "ERROR",JOptionPane.DEFAULT_OPTION);
                    txtFrom.requestFocus();
                    return;
                }
                if (txtTo.getText() == null ||txtTo.getText().equals(""))
                {
                    JOptionPane.showMessageDialog(null, "Enter To", "ERROR",JOptionPane.DEFAULT_OPTION);
                    txtTo.requestFocus();
                    return;
                }
                if (txtDistance.getText() == null ||txtDistance.getText().equals("")) {
                    JOptionPane.showMessageDialog(null, "Enter Distance", "ERROR",JOptionPane.DEFAULT_OPTION);
                ...
                try {
                    ...
                    {
                        String temp = "INSERT INTO Route (Route_No, RouteName, Depot, Destination, Distance,Fare_Charged) VALUES ('" +txtRouteNo.getText() + "', '" +txtRouteName.getText() + "', '" +txtFrom.getText() + "', '" +txtTo.getText() + "', '" +txtDistance.getText() + "',  '" +txtAmount.getText() + "')";
