        ...
        button1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    {
                        String temp = "UPDATE Passenger SET " +"  Pass_Name       ='" + text2.getText() +"',Address         ='" + text3.getText() +"',Tel_No          ='" + text4.getText() +"',Date_of_Travel  ='" + dob.getText() +"',Depot           ='" + combo1.getSelectedItem() +"',Des              ='" + combo2.getSelectedItem() +"' WHERE Pass_No ='" + text1.getText() + "'";
    ...
    public void display(ResultSet rs) {
        try {
            ...
            if (recordNumber) {
                ...
                JOptionPane.showMessageDialog(null, "Record Not found"+recordNumber, "ERROR",JOptionPane.DEFAULT_OPTION);
            }
        } catch (SQLException sqlex) {
            sqlex.printStackTrace();
