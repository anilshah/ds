...
public class Route extends JPanel {
    ...
    labelhead=new JLabel("Routes Details");
     labelhead.setIcon(new ImageIcon(ClassLoader.getSystemResource("images/Routes.png")));
...
//        setSize(800, 400);
        ...
        jButton2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                UpdateRoute frm = new UpdateRoute(jTable.getValueAt(getSelectedRow(), 0).toString(),jTable.getValueAt(getSelectedRow(), 1).toString(),jTable.getValueAt(getSelectedRow(), 2).toString(),jTable.getValueAt(getSelectedRow(), 3).toString(),jTable.getValueAt(getSelectedRow(), 4).toString(),jTable.getValueAt(getSelectedRow(), 5).toString());
                MDIWindow.desktop.add(frm);
                frm.setVisible(true);
                try {
                    frm.setSelected(true);
        ...
        jPanel1.setPreferredSize(new Dimension(screen.width-80, screen.height-300));
    ...
    class AbstractTable extends javax.swing.table.AbstractTableModel {
        ...
        private String[] columnNames = {"RouteNo", "Route Name", "From", "To","Distance[in KM]", "Fare_Charged"};
