        ...
        btnSave.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String sql = "INSERT INTO users (Name,Category,username, password) VALUES ('" +txtName.getText() + "', '" + cmbCategory.getSelectedItem() + "', '" +txtUsername.getText() + "', '" + txtPassword.getText() + "')";
