...
//                g.drawString("Received By         " + new Payment().combo3.getSelectedItem(), 80, 220);
                ...
                g.drawString("Payment Number      " + Payment.rpayNo, 80, 100);
                g.drawString("Name of Passenger   " + Payment.rpassName, 80, 130);
                g.drawString("Amount Paid Rs   " + Payment.ramount, 80, 160);
                g.drawString("Pay on              " + Payment.rmode, 80, 190);
                g.drawString("Date Paid      " + Payment.rdate, 280, 220);
              g.drawString("Received By         " + Payment.rby, 80, 220);
