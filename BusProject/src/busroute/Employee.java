...
public class Employee extends JPanel {
    ...
    labelhead=new JLabel("Employee Details");
     labelhead.setIcon(new ImageIcon(ClassLoader.getSystemResource("images/Emps.png")));
     labelhead.setForeground(Color.blue);
     labelhead.setFont(new Font("Imprint MT Shadow", Font.BOLD, 19));
        ...
        btnUpdate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                NewEntry frm = new NewEntry(taleEmpList.getValueAt(getSelectedRow(), 0).toString(),taleEmpList.getValueAt(getSelectedRow(), 1).toString(),taleEmpList.getValueAt(getSelectedRow(), 2).toString(),taleEmpList.getValueAt(getSelectedRow(), 3).toString(),taleEmpList.getValueAt(getSelectedRow(), 4).toString(),taleEmpList.getValueAt(getSelectedRow(), 5).toString(),taleEmpList.getValueAt(getSelectedRow(), 6).toString(),taleEmpList.getValueAt(getSelectedRow(), 7).toString(),taleEmpList.getValueAt(getSelectedRow(), 8).toString(),taleEmpList.getValueAt(getSelectedRow(), 9).toString());
                MDIWindow.desktop.add(frm);
                frm.setVisible(true);
                try{
                    frm.setSelected(true);
...
//              setVisible(true);
        ...
        tablePanel.add(buttonPanel, java.awt.BorderLayout.SOUTH);
        tablePanel.setPreferredSize(new java.awt.Dimension(screen.width-80, screen.height-300));
    ...
    class AbstractTable extends AbstractTableModel {
        ...
        private String[] columnNames = {"Driver Number", "Surname", "FirstName", "Last Name","Gender", "DOB", "Designation", "Telephone", "E-mail", "Address"};
