            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    Statement statement = DBConnection.getDBConnection().createStatement();
                    {
                        ...
                        String temp = "UPDATE Emp SET " +"  Sname      ='" + txtSname.getText() +"',Fname      ='" + txtFname.getText() +"',Lname      ='" + txtLname.getText() +"',Gender     ='" + cbogender.getSelectedItem() +"',DOB        ='" + dobs.getText() +"',Designation='" + txtDesignation.getText() +"',Telephone  ='" + txttelephone.getText() +"',E_Mail     ='" + txtemail.getText() +"',Address    ='" + txtaddress.getText() +"' WHERE empNo LIKE'" + txtEmpNo.getText() + "'";
