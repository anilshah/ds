...
public class Passengers extends JPanel {
    ...
    labelhead=new JLabel("Passengers Details");
     labelhead.setIcon(new ImageIcon(ClassLoader.getSystemResource("images/pass.png")));
     ...
     labelhead.setFont(new Font("Imprint MT Shadow", Font.BOLD, 19));
        ...
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                UpdatePass frm=new UpdatePass(jTable.getValueAt(getSelectedRow(), 0).toString(),jTable.getValueAt(getSelectedRow(), 1).toString(),jTable.getValueAt(getSelectedRow(), 2).toString(),jTable.getValueAt(getSelectedRow(), 3).toString(),jTable.getValueAt(getSelectedRow(), 4).toString(),jTable.getValueAt(getSelectedRow(), 5).toString(),jTable.getValueAt(getSelectedRow(), 6).toString());
                MDIWindow.desktop.add(frm);
                frm.setVisible(true);
                try{
                    frm.setSelected(true);
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(screen.width-80, screen.height-300));
...
//        setSize(1000, 400);
    ...
    class AbstractTable extends javax.swing.table.AbstractTableModel {
        ...
        private String[] columnNames = {"Passenger_No", "Passenger_Name", "Address", "Telephone_Number","Date_of_Travel", "From", "To"};
